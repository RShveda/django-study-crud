...
from listing.views import SchoolList, SchoolStudentList, StudentDetailView, StudentCreateView, StudentUpdateView, SchoolCreateView, StudentDeleteView
...
urlpatterns = [
    ...
    path('school_form', SchoolCreateView.as_view(), name = "create_school"),
